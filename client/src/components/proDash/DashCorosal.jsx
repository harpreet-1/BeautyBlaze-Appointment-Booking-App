...
function DashCorosal() {
  ...
  useEffect(() => {
    ...
    let token =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiZWF1dHlQcm9mZXNzaW9uYWxJZCI6IjY0OGVmMTg0ZjIwNTJlYTNkY2I2ZjIwNCIsImlhdCI6MTY4NzA5MjQ5OSwiZXhwIjoxNjg3Njk3Mjk5fQ.zdftj1h5VjUlmLt-PZh4-bxS0PtlDSpsLghyA8huHeo";
